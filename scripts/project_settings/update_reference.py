...
def main():
  ...
  api_ps.setReference(mosaicConfig, args.project_id, args.reference)
...
def getArgs():
  ...
  additionalArgs.append({'long': '--reference', 'short': '-r', 'required': True, 'metavar': 'string', 'help': 'The reference to update the project to'})
