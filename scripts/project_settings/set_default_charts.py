...
def main():
  ...
  args.column_ids = args.column_ids.split(',')
  args.chart_ids  = args.chart_ids.split(',')
  api_ps.setDefaultTableAndCharts(mosaicConfig, args.project_id, args.column_ids, args.chart_ids)
...
def getArgs():
  ...
  additionalArgs.append({'long': '--chart_ids', 'short': '-r', 'required': True, 'metavar': 'integer', 'help': 'A comma separated list of chart ids that defines the charts shown in Analytics'})
