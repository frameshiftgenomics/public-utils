...
def updateFile(args):
  ...
  for sampleFile in jsonData['data']:
    if not args.file_id: print(sampleFile['name'], ": ", sampleFile['id'], ", sample_id: ", sampleFile['sample_id'], ", uri: ", sampleFile['uri'], sep = "")
    if args.file_id:
  ...
  # Update the file name
    ...
    try: data = os.popen(api_sf.putUpdateSampleFileName(mosaicConfig, args.name, args.project, sampleId, args.file_id)).read()
