...
def parseCommandLine():
  ...
  parser.add_argument('--values', '-l', required = True, metavar = "string", help = 'A comma separated list of predefined values for the sample attribute')
