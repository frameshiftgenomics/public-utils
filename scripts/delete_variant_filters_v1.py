...
def main():
  ...
  deleteAllVariantFilters(mosaicConfig, args.project_id)
...
# Routines for script
def deleteAllVariantFilters(mosaicConfig, projectId):

  # First get the ids of all the variant filters in the project
  filterIds = api_vf.getVariantFilterIds(mosaicConfig, projectId)

  # Delete all of the filters
  api_vf.deleteAllVariantFiltersInProject(mosaicConfig, projectId, filterIds)
  print('All variant filters successfully deleted')
