...
#  sampleMap                 = createSampleMap(samples)
  ...
  filters                   = getFilters(filtersInfo, filterCategories, filters, annotations, annotationUids, annotationMap, annotationUids)#, hpoTerms)
...
def getFilters(filtersInfo, categories, filters, annotations, annotationUids, annotationMap, uids):#, hpoTerms):
